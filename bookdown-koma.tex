...
$else$            % Classic Thesis geometry, wide side margin
\usepackage{geometry}
...
% FIXME: Debug warnings caused by microtrype protrusion w/ xelatex
%\usepackage[protrusion=true,final]{microtype} % Improve paragraph aspect
...
$endfor$
  ...
  \gappto\captionsspanish{%
  	...
  	\def\listingscaption{Código}%       % Code listing
  	...
  	\def\listoflistingsname{Índice de listas de código}   % Code listings index
  }
\fi
$endif$
